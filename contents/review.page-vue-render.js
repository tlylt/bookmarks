...
with(this){return _c('h2',{attrs:{"id":"what-to-say"}},[_c('span',{staticClass:"anchor",attrs:{"id":"what-to-say"}}),_v("What To Say"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#what-to-say","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"case-1-if-it-s-a-clear-bug"}},[_c('span',{staticClass:"anchor",attrs:{"id":"case-1-if-it-s-a-clear-bug"}}),_v("Case 1: If it’s a clear bug"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#case-1-if-it-s-a-clear-bug","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"case-2-the-code-technically-works-but-you-want-it-to-look-nicer"}},[_c('span',{staticClass:"anchor",attrs:{"id":"case-2-the-code-technically-works-but-you-want-it-to-look-nicer"}}),_v("Case 2: The code technically works, but you want it to look nicer"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#case-2-the-code-technically-works-but-you-want-it-to-look-nicer","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"case-3-you-have-comments-on-the-high-level-approach"}},[_c('span',{staticClass:"anchor",attrs:{"id":"case-3-you-have-comments-on-the-high-level-approach"}}),_v("Case 3: You have comments on the high-level approach"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#case-3-you-have-comments-on-the-high-level-approach","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
